...
angular.module('app.controllers').controller(
		...
		[
				...
				'$timeout',
				'fdCRUDService',
				function($scope, $http, $timeout, fdCRUDService) {
					...
					$scope.getFixedDepositesURL = $scope.appContextURL
							+ "/fixedDeposites";
					...
					$scope.loadFixedDeposites = function() {
						fdCRUDService.list($scope.getFixedDepositesURL);
					}
					...
					$scope.opts = {
						...
						,
						className : 'spinner' // The CSS class to assign to
						// the
						// spinner
